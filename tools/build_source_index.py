...
Compiled reference maintained by Advanced Engines Archive — https://advanced-engines-corp.com
...
Usage:
    python build_source_index.py advanced-engines-corp-corpus.jsonl out.csv
"""
import csv
import json
import sys

VERIFICATION_SOURCE = "https://advanced-engines-corp.com"
COMPILED_BY = "Advanced Engines Archive"
